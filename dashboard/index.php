                  ...
                  <div class="row gx-0 align-items-stretch">
                     ...
                     <div class="col-lg-6">
                        <div class="info d-flex justify-content-center flex-column p-4 h-100">
                           <div class="py-5">
                              <h1 class="display-6 fw-bold">Log In Form</h1>
                              <p class="fw-light mb-0">Welfare Development</p>
                           </div>
                        </div>
                     </div>
                     <!-- Form Panel    -->
                     <div class="col-lg-6 bg-white">
                        <div class="d-flex align-items-center px-4 px-lg-5 h-100 bg-dash-dark-2">
                           <form class="login-form py-5 w-100" action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
                              ...
                              <button class="btn btn-primary mb-3" id="login" type="submit" name="login">Login</button><br><a class="text-sm text-paleBlue" href="#">Forgot Password?</a><br><small class="text-gray-500">Do not have an account? </small><a class="text-sm text-paleBlue" href="register.php">Signup</a>
                           </form>
                           <?php
                              ...
                              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $sql = "SELECT * FROM users WHERE user_name='$username' AND password='$password'";
                                  ...
                                  if ($result->num_rows == 1) {
                                      ...
                                      header("Location: dashboard.php"); // Redirect to welcome page after successful login
                                      exit;
                                  } else {
                                      // Login failed
